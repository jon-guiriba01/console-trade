...
}(this, (function (exports,_angular_core,angularfire2,rxjs,rxjs_operators,_firebase_database) { 'use strict';
...
var AngularFireDatabase = (function () {
    function AngularFireDatabase(options, config, name, databaseURL, zone) {
    ...
    AngularFireDatabase.ctorParameters = function () { return [
        ...
        { type: undefined, decorators: [{ type: _angular_core.Inject, args: [angularfire2.FirebaseAppConfigToken,] },] },

...
}(this, (function (exports,_angular_core,rxjs,rxjs_operators,angularfire2,_firebase_firestore) { 'use strict';
...
var AngularFirestore = (function () {
    function AngularFirestore(options, config, name, shouldEnablePersistence, settings, platformId, zone) {
        var _this = this;
    ...
    AngularFirestore.ctorParameters = function () { return [
        ...
        { type: undefined, decorators: [{ type: _angular_core.Optional }, { type: _angular_core.Inject, args: [angularfire2.FirebaseAppConfigToken,] },] },
        { type: undefined, decorators: [{ type: _angular_core.Optional }, { type: _angular_core.Inject, args: [angularfire2.FirebaseAppNameToken,] },] },
